function [Flag,MaxMin_vec,CV_ISI_vec  ]  = Test_Ir(spike_time_states,Inj_vec, MaxMin_thr, ISI_thr, plot_flag )
%   A test for the irregularity. Need to check several times. 
    ...
    Flag1=nanmax(MaxMin_vec)>MaxMin_thr;
